                      ...
                      (item, index) => (
                        ...
                        >
                          ...
                          {/* EDIT TOTAL — NOW AVAILABLE TO BOTH ADMIN AND PARTNER.
                              ...
                              CAUTION: productSubtotal is a single shared field
                              on the order doc — on multi-partner orders, whichever
                              role saves last overwrites the whole order's total
                              with their own (possibly partial) number. Flag this
                              to the dev if orders can contain multiple partners'
                              items; a per-partner override field is the fix. */}
